...
| C2 빈·선택·오류 상태 설명 | Codex | 구현·검증 완료, 통합 대기 | `codex/c2-state-guidance` · 여섯 패널 공통 StateHint, 새 순수 판정 단위 9개·E2E 2개; `pnpm gate` 9/9 PASS(단위 650·Chromium E2E 45), 한국어 최소 폭 스크린샷 3장 시각 검증. [상태 목록·검증 메모](evaluations/2026-09-06-c2-state-guidance.md), 다음은 C3 |
